...
// ==============================================================
#ifndef __doHistStrech_sitodEe__HH__
#define __doHistStrech_sitodEe__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(doHistStrech_sitodEe) {
    ...
    SC_CTOR(doHistStrech_sitodEe):  ACMP_sitofp_U ("ACMP_sitofp_U") {
