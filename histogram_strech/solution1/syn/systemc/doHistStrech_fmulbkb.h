...
// ==============================================================
#ifndef __doHistStrech_fmulbkb__HH__
#define __doHistStrech_fmulbkb__HH__
#include "ACMP_fmul.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(doHistStrech_fmulbkb) {
    ...
    SC_CTOR(doHistStrech_fmulbkb):  ACMP_fmul_U ("ACMP_fmul_U") {
        ACMP_fmul_U.clk(clk);
