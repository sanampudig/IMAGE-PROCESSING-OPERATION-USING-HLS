...
// ==============================================================
#ifndef __doHistStrech_fdivcud__HH__
#define __doHistStrech_fdivcud__HH__
#include "ACMP_fdiv.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(doHistStrech_fdivcud) {
    ...
    SC_CTOR(doHistStrech_fdivcud):  ACMP_fdiv_U ("ACMP_fdiv_U") {
        ACMP_fdiv_U.clk(clk);
