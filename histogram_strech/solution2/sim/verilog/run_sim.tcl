...
if {[file isfile doHistStrech.autotvin.dat]} {
	file delete -force doHistStrech.autotvin.dat
}

if {[file isfile doHistStrech.autotvout.dat]} {
	file delete -force doHistStrech.autotvout.dat
}
