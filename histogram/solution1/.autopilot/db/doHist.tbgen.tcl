...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "230659", "EstimateLatencyMax" : "230659",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.doHist_CTRL_BUS_s_axi_U", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "230659", "Max" : "230659"}
	, {"Name" : "Interval", "Min" : "230660", "Max" : "230660"}
]}
...
set Spec2ImplPortList { 
	...
	histo { bram {  { histo_Addr_A MemPortADDR2 1 32 }  { histo_EN_A MemPortCE2 1 1 }  { histo_WEN_A MemPortWE2 1 4 }  { histo_Din_A MemPortDIN2 1 32 }  { histo_Dout_A MemPortDOUT2 0 32 }  { histo_Clk_A mem_clk 1 1 }  { histo_Rst_A mem_rst 1 1 } } }
}
