...
architecture behav of doHist is 
    ...
    "doHist,hls_ip_2018_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=5.806000,HLS_SYN_LAT=230659,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=147,HLS_SYN_LUT=312,HLS_VERSION=2018_3}";
    ...
    signal idxHist_reg_112 : STD_LOGIC_VECTOR (8 downto 0);
    ...
    signal tmp_fu_146_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_3_fu_167_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal histo_Addr_A_orig : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_4_fu_172_p2 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    idxPixel_reg_123_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
                idxPixel_reg_123 <= ap_const_lv17_0;
            elsif ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
                idxPixel_reg_123 <= idxPixel_1_reg_189;
            end if; 
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((exitcond_fu_151_p2 = ap_const_lv1_0) and (inStream_V_data_V_0_vld_out = ap_const_logic_0))) and (exitcond_fu_151_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state4))) then
                histo_addr_1_reg_194 <= tmp_3_fu_167_p1(8 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state5)) then
                histo_load_reg_199 <= histo_Dout_A;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((exitcond_fu_151_p2 = ap_const_lv1_0) and (inStream_V_data_V_0_vld_out = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state4))) then
                idxPixel_1_reg_189 <= idxPixel_1_fu_157_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, inStream_V_data_V_0_vld_out, ap_CS_fsm_state4, exitcond_fu_151_p2, ap_CS_fsm_state2, exitcond2_fu_134_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state4 => 
                if ((not(((exitcond_fu_151_p2 = ap_const_lv1_0) and (inStream_V_data_V_0_vld_out = ap_const_logic_0))) and (exitcond_fu_151_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                elsif ((not(((exitcond_fu_151_p2 = ap_const_lv1_0) and (inStream_V_data_V_0_vld_out = ap_const_logic_0))) and (exitcond_fu_151_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state4))) then
    ...
    ap_block_state4_assign_proc : process(inStream_V_data_V_0_vld_out, exitcond_fu_151_p2)
    begin
                ap_block_state4 <= ((exitcond_fu_151_p2 = ap_const_lv1_0) and (inStream_V_data_V_0_vld_out = ap_const_logic_0));
    end process;


    ap_done_assign_proc : process(inStream_V_data_V_0_vld_out, ap_CS_fsm_state4, exitcond_fu_151_p2)
    begin
        if ((not(((exitcond_fu_151_p2 = ap_const_lv1_0) and (inStream_V_data_V_0_vld_out = ap_const_logic_0))) and (exitcond_fu_151_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    ap_ready_assign_proc : process(inStream_V_data_V_0_vld_out, ap_CS_fsm_state4, exitcond_fu_151_p2)
    begin
        if ((not(((exitcond_fu_151_p2 = ap_const_lv1_0) and (inStream_V_data_V_0_vld_out = ap_const_logic_0))) and (exitcond_fu_151_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    exitcond2_fu_134_p2 <= "1" when (idxHist_reg_112 = ap_const_lv9_100) else "0";
    exitcond_fu_151_p2 <= "1" when (idxPixel_reg_123 = ap_const_lv17_12C00) else "0";
    histo_Addr_A <= std_logic_vector(shift_left(unsigned(histo_Addr_A_orig),to_integer(unsigned('0' & ap_const_lv32_2(31-1 downto 0)))));

    histo_Addr_A_orig_assign_proc : process(ap_CS_fsm_state4, ap_CS_fsm_state2, histo_addr_1_reg_194, ap_CS_fsm_state6, tmp_fu_146_p1, tmp_3_fu_167_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
            histo_Addr_A_orig <= std_logic_vector(IEEE.numeric_std.resize(unsigned(histo_addr_1_reg_194),32));
        elsif ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
            histo_Addr_A_orig <= tmp_3_fu_167_p1(32 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            histo_Addr_A_orig <= tmp_fu_146_p1(32 - 1 downto 0);
        else 
    ...
    histo_Din_A_assign_proc : process(ap_CS_fsm_state2, ap_CS_fsm_state6, tmp_4_fu_172_p2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
            histo_Din_A <= tmp_4_fu_172_p2;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    histo_EN_A_assign_proc : process(inStream_V_data_V_0_vld_out, ap_CS_fsm_state4, exitcond_fu_151_p2, ap_CS_fsm_state2, ap_CS_fsm_state6)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state6) or (ap_const_logic_1 = ap_CS_fsm_state2) or (not(((exitcond_fu_151_p2 = ap_const_lv1_0) and (inStream_V_data_V_0_vld_out = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state4)))) then 
    ...
    histo_WEN_A_assign_proc : process(ap_CS_fsm_state2, exitcond2_fu_134_p2, ap_CS_fsm_state6)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state6) or ((exitcond2_fu_134_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2)))) then 
    ...
    idxHist_1_fu_140_p2 <= std_logic_vector(unsigned(idxHist_reg_112) + unsigned(ap_const_lv9_1));
    idxPixel_1_fu_157_p2 <= std_logic_vector(unsigned(idxPixel_reg_123) + unsigned(ap_const_lv17_1));

    inStream_TDATA_blk_n_assign_proc : process(inStream_V_data_V_0_state, ap_CS_fsm_state4, exitcond_fu_151_p2)
    begin
        if (((exitcond_fu_151_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    inStream_V_data_V_0_ack_out_assign_proc : process(inStream_V_data_V_0_vld_out, ap_CS_fsm_state4, exitcond_fu_151_p2)
    begin
        if ((not(((exitcond_fu_151_p2 = ap_const_lv1_0) and (inStream_V_data_V_0_vld_out = ap_const_logic_0))) and (exitcond_fu_151_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    inStream_V_dest_V_0_ack_out_assign_proc : process(inStream_V_data_V_0_vld_out, ap_CS_fsm_state4, exitcond_fu_151_p2)
    begin
        if ((not(((exitcond_fu_151_p2 = ap_const_lv1_0) and (inStream_V_data_V_0_vld_out = ap_const_logic_0))) and (exitcond_fu_151_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    tmp_3_fu_167_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(inStream_V_data_V_0_data_out),64));
    tmp_4_fu_172_p2 <= std_logic_vector(unsigned(histo_load_reg_199) + unsigned(ap_const_lv32_1));
    tmp_fu_146_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(idxHist_reg_112),64));
end behav;
