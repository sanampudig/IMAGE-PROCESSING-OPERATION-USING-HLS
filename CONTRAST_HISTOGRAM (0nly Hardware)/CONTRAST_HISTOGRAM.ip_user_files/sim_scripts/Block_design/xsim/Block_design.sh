...
simulate()
{
  xsim Block_design -key {Behavioral:sim_1:Functional:Block_design} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_aa4b.protoinst" -protoinst "protoinst_files/Block_design.protoinst" -log simulate.log
}
