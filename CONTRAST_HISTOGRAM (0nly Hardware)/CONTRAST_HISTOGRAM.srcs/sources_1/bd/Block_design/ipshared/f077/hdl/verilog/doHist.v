...
(* CORE_GENERATION_INFO="doHist,hls_ip_2018_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=5.806000,HLS_SYN_LAT=230659,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=147,HLS_SYN_LUT=312,HLS_VERSION=2018_3}" *)
...
reg   [16:0] idxPixel_1_reg_189;
reg    ap_block_state4;
reg   [7:0] histo_addr_1_reg_194;
reg   [31:0] histo_load_reg_199;
wire    ap_CS_fsm_state5;
reg   [8:0] idxHist_reg_112;
wire   [0:0] exitcond2_fu_134_p2;
reg   [16:0] idxPixel_reg_123;
wire    ap_CS_fsm_state6;
wire    ap_CS_fsm_state3;
wire   [63:0] tmp_fu_146_p1;
wire   [63:0] tmp_3_fu_167_p1;
reg   [31:0] histo_Addr_A_orig;
wire   [31:0] tmp_4_fu_172_p2;
reg   [5:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((exitcond2_fu_134_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        ...
        idxHist_reg_112 <= 9'd0;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        idxPixel_reg_123 <= 17'd0;
...
always @ (posedge ap_clk) begin
    if ((~((exitcond_fu_151_p2 == 1'd0) & (inStream_V_data_V_0_vld_out == 1'b0)) & (exitcond_fu_151_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
        histo_addr_1_reg_194 <= tmp_3_fu_167_p1;
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((exitcond_fu_151_p2 == 1'd0) & (inStream_V_data_V_0_vld_out == 1'b0)) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (*) begin
    if ((~((exitcond_fu_151_p2 == 1'd0) & (inStream_V_data_V_0_vld_out == 1'b0)) & (exitcond_fu_151_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        histo_Addr_A_orig = histo_addr_1_reg_194;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
        histo_Addr_A_orig = tmp_3_fu_167_p1;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        histo_Addr_A_orig = tmp_fu_146_p1;
    end else begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state6) | (1'b1 == ap_CS_fsm_state2) | (~((exitcond_fu_151_p2 == 1'd0) & (inStream_V_data_V_0_vld_out == 1'b0)) & (1'b1 == ap_CS_fsm_state4)))) begin
        histo_EN_A = 1'b1;
    end else begin
        histo_EN_A = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state6) | ((exitcond2_fu_134_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2)))) begin
        histo_WEN_A = 4'd15;
    end else begin
        histo_WEN_A = 4'd0;
    end
...
always @ (*) begin
    if (((exitcond_fu_151_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state4 : begin
            if ((~((exitcond_fu_151_p2 == 1'd0) & (inStream_V_data_V_0_vld_out == 1'b0)) & (exitcond_fu_151_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
                ap_NS_fsm = ap_ST_fsm_state1;
            end else if ((~((exitcond_fu_151_p2 == 1'd0) & (inStream_V_data_V_0_vld_out == 1'b0)) & (exitcond_fu_151_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (*) begin
    ap_block_state4 = ((exitcond_fu_151_p2 == 1'd0) & (inStream_V_data_V_0_vld_out == 1'b0));
end
...
assign exitcond2_fu_134_p2 = ((idxHist_reg_112 == 9'd256) ? 1'b1 : 1'b0);

assign exitcond_fu_151_p2 = ((idxPixel_reg_123 == 17'd76800) ? 1'b1 : 1'b0);
...
assign idxHist_1_fu_140_p2 = (idxHist_reg_112 + 9'd1);

assign idxPixel_1_fu_157_p2 = (idxPixel_reg_123 + 17'd1);
...
assign tmp_3_fu_167_p1 = inStream_V_data_V_0_data_out;

assign tmp_4_fu_172_p2 = (histo_load_reg_199 + 32'd1);

assign tmp_fu_146_p1 = idxHist_reg_112;
